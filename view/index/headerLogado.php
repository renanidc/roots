        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse opcoes" id="bs-example-navbar-collapse-1"> 
                ...
                <ul class="nav navbar-nav">
                    <li>
                        <a href="index.php?controller=Authenticate&action=perfil"> Carrinho
                        <span class="glyphicon glyphicon-shopping-cart"></span>
                        
                        <?php 
                            if(isset($_SESSION['CART'])){
                                echo '<span class="label label-danger">'.sizeof($_SESSION['CART']).'</span>';
                            }
                        ?>
                    ...
                    <li>
                        <a href="index.php?controller=Authenticate&action=perfil">Perfil
